  ...
  return (
    <View>
        ...
        <ScrollView style={{backgroundColor:'white'}} contentContainerStyle={{paddingBottom:100}}>
            ...
            <View style={{padding:20, paddingTop:0, paddingBottom:70}}>
                <View style={{paddingBottom:10}}>
                    <Text style={{fontSize:16}}>Por favor, anexe o comprovante de residência atualizado para dar continuidade ao processo. O documento deve estar em nome do solicitante ou de um responsável legal e conter informações legíveis, como endereço completo e data de emissão recente.</Text>
                </View>
            </View>
